...
private:
    ...
    void populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
        ...
        createInfo.pfnUserCallback = HelloVideo::debugCallback;
    ...
    void createDescriptorSets() {
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
            ...
            bufferInfo.buffer = renderer->uniformBuffers[i]->GetBuffer();
            bufferInfo.offset = 0;
    ...
    void createUniformBuffers() {
        ...
        renderer->uniformBuffers.resize(MAX_FRAMES_IN_FLIGHT);
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
            ...
            uniformBuffer->Map();
            renderer->uniformBuffers[i] = uniformBuffer;
    ...
    void createGraphicsPipeline() {
        ...
        auto vertShaderCode = HelloVideo::readFile("shaders/vert.spv");
        auto fragShaderCode = HelloVideo::readFile("shaders/frag.spv");
